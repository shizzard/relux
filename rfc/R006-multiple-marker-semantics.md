...
This AND emerges naturally: `run if X` means "skip if not X". OR over those skip decisions gives skip if not-A or not-B, which is equivalent to run if A and B (De Morgan's law).
