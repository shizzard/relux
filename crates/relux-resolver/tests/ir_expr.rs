...
#[test]
fn lower_pure_expr_capture_ref_allowed_in_pure_fn_body() {
    let mut ctx = ctx_with_source("fn dummy() {}");
    push_test_scope(&mut ctx, "tests/a");
    let file = file_id_for(&ctx, "tests/a");
...
#[test]
fn lower_pure_expr_string_capture_ref_in_parts_allowed_in_pure_fn_body() {
    let mut ctx = ctx_with_source("fn dummy() {}");
    push_test_scope(&mut ctx, "tests/a");
    let file = file_id_for(&ctx, "tests/a");
...
#[test]
fn lower_pure_expr_string_still_rejects_qualified_var_in_pure_fn_body() {
    let mut ctx = ctx_with_source("fn dummy() {}");
    push_test_scope(&mut ctx, "tests/a");
    let file = file_id_for(&ctx, "tests/a");
